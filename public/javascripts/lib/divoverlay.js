function DivOverlay(text, map, position) {
  var businessNameDiv = document.createElement('div');
  var pNode = document.createElement('span');
  pNode.className = 'popup_text';
  var businessNameTextNode = document.createTextNode(text);
  pNode.appendChild(businessNameTextNode)
  businessNameDiv.className = 'popup';
  businessNameDiv.appendChild(pNode);

  // Now initialize all properties.
  this.div_ = businessNameDiv;
  this.map_ = map;
